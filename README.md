...
| **2** | Sep 1–5 | **Python Foundations**: <ol><li>Continue VSCode + Git workflow ([Setup Guide](materials/setup.md)). [File Systems](https://computational-expression.github.io/course_information/week02/file_systems.html).</li><li> Intro to Python basics.</li></ol> | <li> Practice terminal commands </li> <li>Class Activity: Python Programming Exercise <li> | LO1, LO2; ME (expression through code), SP (scientific reasoning with symbolic models). |
