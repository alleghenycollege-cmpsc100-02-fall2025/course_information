...
|------|-------|--------|------------------------|-------------------------|
| **1** | Aug 26–29 | **Course Introduction & Computational Thinking**: [Overview of CIS](https://docs.google.com/presentation/d/e/2PACX-1vQCMNP1R96XEBOCXslFt317L8TGzKoIIGnh7sfczqAk_9_KGzzFAYwDWm8JtbRY5Q/pub?start=false&loop=false&delayms=3000). What is an algorithm? Abstraction, problem-solving. Begin setup of VSCode and Git. | Class Activity: Algorithm Thinking. VSCode & Git Setup Workshop ([Setup Guide](materials/setup.md)). Read: Syllabus & Department Policies.| LO1, LO2; ME (expression through symbolic systems), SP (algorithmic reasoning, inquiry into computing as a science). |
