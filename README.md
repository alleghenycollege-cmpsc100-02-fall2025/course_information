...
|------|-------|--------|------------------------|-------------------------|
| **1** | Aug 26–29 | **Course Introduction & Computational Thinking**: [Overview of CIS](https://docs.google.com/presentation/d/e/2PACX-1vQCMNP1R96XEBOCXslFt317L8TGzKoIIGnh7sfczqAk_9_KGzzFAYwDWm8JtbRY5Q/pub?start=false&loop=false&delayms=3000). What is an algorithm? Abstraction, problem-solving. Begin setup of VSCode and Git. | <ul><li>Class Activities: Algorithm Thinking. VSCode & Git Setup Workshop ([Setup Guide](materials/setup.md)).</li> <li>Read: Syllabus & Department Policies. </li></ul>| LO1, LO2; ME (expression through symbolic systems), SP (algorithmic reasoning, inquiry into computing as a science). |
| **2** | Sep 1–5 | **Python Foundations**:  Intro to Python basics: expressions, types. Input/output, variables, assignment, operators. Continue VSCode + Git workflow. Practice writing, saving, and running simple programs. | Class Activity: Variable Practice, Python Programming Exercises | LO1, LO2; ME (expression through code), SP (scientific reasoning with symbolic models). |
| **3** | Sep 8–12 | **Control Flow I**: Conditionals, Boolean logic, tracing execution. Computational problem-solving with decisions. | Lab 1: Conditionals, Class Activity: Boolean Logic | LO1; SP (logical reasoning as inquiry). |
...
| **11** | Nov 3–7 | **Object-Oriented Programming II**: Methods, encapsulation. Begin project design (original computational artifact). <br>**Nov 4: All-College Programming Day (no class)** | Lab 8: Methods & Encapsulation, Project Proposal Workshop | LO1, LO5; ME (creating expressive computational artifacts). |
...
| **14** | Nov 24–25 | **Final Project** + wrap-up. Review for Data Structures: recursion intro, data abstractions, course reflection. <br>**Nov 26–30: Thanksgiving Break (no class)** | **Final Project Presentations**, Course Reflection Activities | LO1–5; ME (presentation & expression), SP (scientific reflection, inquiry). |
| **15** | Dec 1–5 | **Final Project** + wrap-up. Review for Data Structures: recursion intro, data abstractions, course reflection. | **Final Project**, Final Exam Review, Recursion Introduction | LO1–5; ME (presentation & expression), SP (scientific reflection, inquiry). |
