...
| **4** | Sep 15–19 | <li>**Control Flow I**: [Conditionals, Boolean logic](https://computational-expression.github.io/course_information/week03/conditionals.html).</li> <li>**Control Flow II**: Loops, iteration patterns.</li> | <li>[Lab 2](https://classroom.github.com/a/Kn4PBGkI) (DUE: 2:30pm Sep. 22)</li> <li>[Activity 2: Team Synergy](https://classroom.github.com/a/y-nsZX5n) (DUE: 9:30am Sep. 18)</li> <li> Read(optional): [If-else and Control Flow](https://automatetheboringstuff.com/3e/chapter2.html)</li>| LO1; SP (iterative exploration of solutions). |
| **5** | Sep 22–26 | **Functions & Modular Design**: Parameters, return values, scope. Writing reusable code. | Lab 3 | LO1, LO2; ME (expression through modular organization). |
| **6** | Sep 29–Oct 3 | **Data Structures I**: Lists, indexing, iteration. Problem-solving with collections. | Lab 4 | LO1; SP (organizing & analyzing data). |
| **7** | Oct 6–8 | **Data Structures II**: Dictionaries, key/value mappings. Debugging strategies and error messages. <br>**Oct 9–12: Fall Break (no class)** | Lab 5, Class Activity: Debugging Practice | LO1, LO3; SP (structured data, error correction). |
...
| **9** | Oct 20–24 | **Testing & Debugging**: Testing functions, systematic debugging, revising programs for correctness. | Lab 6 | LO2, LO3; SP (systematic problem solving). |
