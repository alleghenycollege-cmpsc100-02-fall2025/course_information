...
| **3** | Sep 8–12 | <li>**Python Foundations II**: [Slides: Types & Operations](https://computational-expression.github.io/course_information/week03/types_operations.html) </li> <li>**Control Flow I**: Conditionals, Boolean logic.</li>  | Lab 1: Conditionals, Class Activity: Boolean Logic | LO1; SP (logical reasoning as inquiry). |
