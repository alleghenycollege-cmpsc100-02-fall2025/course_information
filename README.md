...
| **6** | Sep 29–Oct 3 | **Data Structures I**: [Lists](https://computational-expression.github.io/course_information/week06/lists.html). | <li>[Activity 5: NFL Fantasy]</li> <li>[Lab 4](https://classroom.github.com/a/zfcqT0bo) (DUE: 2:30pm Oct. 6)</li> <li> Read(optional): [Debugging](https://automatetheboringstuff.com/3e/chapter5.html) and [Lists](https://automatetheboringstuff.com/3e/chapter6.html).</li>| LO1; SP (organizing & analyzing data). |
| **7** | Oct 6–8 | **Functions & Modular Design**: Parameters, return values, scope. Writing reusable code. <br>**Oct 9–12: Fall Break (no class)** | Lab 5, Class Activity: Debugging Practice | LO1, LO3; SP (structured data, error correction). |
