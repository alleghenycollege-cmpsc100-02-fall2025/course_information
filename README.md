...
| **4** | Sep 15–19 | <li>**Control Flow I**: [Conditionals, Boolean logic](https://computational-expression.github.io/course_information/week03/conditionals.html).</li> <li>**Control Flow II**: Loops, iteration patterns.</li> | <li>[Lab 2](https://classroom.github.com/a/Kn4PBGkI) (DUE: 2:30pm Sep. 22)</li> <li>Class Activity</li> | LO1; SP (iterative exploration of solutions). |
