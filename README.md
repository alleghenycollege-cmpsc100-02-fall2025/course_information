...
|------|-------|--------|------------------------|-------------------------|
| **1** | Aug 26–29 | **Course Introduction & Computational Thinking**: Overview of CIS. What is an algorithm? Abstraction, problem-solving. Begin setup of VSCode and Git. Intro to Python basics: expressions, types. | Class Activity: Algorithm Thinking, VSCode & Git Setup Workshop. **No lab on August 27th.** | LO1, LO2; ME (expression through symbolic systems), SP (algorithmic reasoning, inquiry into computing as a science). |
| **2** | Sep 1–5 | **Python Foundations**: Input/output, variables, assignment, operators. Continue VSCode + Git workflow. Practice writing, saving, and running simple programs. | Class Activity: Variable Practice, Python Programming Exercises | LO1, LO2; ME (expression through code), SP (scientific reasoning with symbolic models). |
