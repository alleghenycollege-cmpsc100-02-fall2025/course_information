...
| **7** | Oct 6–8 | [Lists](https://computational-expression.github.io/course_information/week06/lists.html). <br>**Oct 9–12: Fall Break (no class)** | Lab 5, Class Activity: Debugging Practice | LO1, LO3; SP (structured data, error correction). |
| **8** | Oct 13–17 | **Midterm Week**: In-class review and **Midterm Exam on Oct. 16 at 9:30am**.  | Midterm Review Session, Midterm Exam, Code Analysis Kickoff | LO3; SP (critical analysis of algorithms). |
