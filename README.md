...
| **3** | Sep 8–12 | <li>**Python Foundations II**: [Slides: Types & Operations](https://computational-expression.github.io/course_information/week03/types_operations.html) </li> <li>**Control Flow I**: Conditionals, Boolean logic.</li>  | <li>[Lab 1: Sensor Dashboard](https://classroom.github.com/a/lkTA2x4Z).</li> <li>[Activity1: Calculator](https://classroom.github.com/a/kbwzsVx4)</li> | LO1; SP (logical reasoning as inquiry). |
