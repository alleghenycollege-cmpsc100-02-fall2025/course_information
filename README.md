...
| **11** | Nov 3–7 | <li>[Git Flow](https://computational-expression.github.io/course_information/week11/git_and_vscode_tools.html)</li> <li>**Object-Oriented Programming I**: [Classes, objects, attributes.](https://computational-expression.github.io/course_information/week11/oop_intro.html)</li> <br>**Nov 4: All-College Programming Day (no class)** | <li>[Lab 8: IoT with Git Flow](https://classroom.github.com/a/Xm8JLPHi) (DUE: 2:30pm Nov. 10)</li> <li>Activity 9: Resolve "Feedback Issue" in Lab 6</li>| LO1, LO5; ME (creating expressive computational artifacts). |
